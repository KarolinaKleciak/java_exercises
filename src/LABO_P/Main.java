...
public class Main {
    public static void main(String[] args) {
        ...
        ComissionCar store = new ComissionCar();
       ...
       // store.printCars(); zwykle wyswietlenie

        //wyswietlenie lambda-> ZAD5
        store.printCars_2();

        //sortowanie -> ZAD5
        store.sortCarsByEngineCapacity();
        System.out.println("\n\nEngine element in ascending order: ");
        store.printCars();
